...
class _LocationVendorsMapScreenState extends State<LocationVendorsMapScreen>
  ...
  Future<void> _fetchCurrentLocationOnce() async {
    try {
      ...
      // ✅ LOCK it once (won't change when you move the map)
  ...
  // ✅ This keeps your "You're here" overlay pinned to your REAL location while panning
                          ...
                          return Stack(
                            children: [
                              GoogleMap(
                                ...
                                onTap: (_) => _hidePopup(),
                                markers: _vendorMarkers, // ✅ vendors only
                              ...
                              // ✅ CURRENT LOCATION MARKER: same design + fade + text "You're here"
                              if (_myScreenPx != null)
...
class _FadingYouAreHereMarker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      left: left,
      top: top,
      child: IgnorePointer( // ✅ cannot be moved / dragged
...
Future<BitmapDescriptor> markerFromAssetAtDp(
  ...
  final codec = await ui.instantiateImageCodec(data.buffer.asUint8List(), targetWidth: targetWidthPx);
  final frame = await codec.getNextFrame();
  final bytes = await frame.image.toByteData(format: ui.ImageByteFormat.png);
  return BitmapDescriptor.fromBytes(bytes!.buffer.asUint8List());
}

class _FadingCurrentLocationOverlay extends StatelessWidget {
  const _FadingCurrentLocationOverlay({
    required this.mapSize,
    required this.anchor,
    required this.liftPx,
    required this.size,
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (_, i) {
        ...
        return GestureDetector(onTap: () => onTapShop(v), child: _VendorCard(v: v));
      },
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          ...
          style: const TextStyle(fontFamily: 'ClashGrotesk', fontWeight: FontWeight.w900, fontSize: 13.5, color: Color(0xFF111827)),
        ),
      ],
    ),
  );
          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                if (_isSponsoredOne) Positioned(right: 10, top: 10, child: _jsonSponsoredPill()),
              ],
            ),
          ),
          Expanded(
...
Widget _jsonSponsoredPill() {
  return Container(
    ...
    child: const Text(
      'Sponsored',
      style: TextStyle(fontFamily: 'ClashGrotesk', fontWeight: FontWeight.w900, fontSize: 12, color: Colors.white, letterSpacing: .2),
    ),
  );
}
          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                // ✅ show exact API-like label on sponsored cards
                if (_isSponsoredOne)
                  Positioned(
                    right: 10,
                    top: 10,
