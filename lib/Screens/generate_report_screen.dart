...
// ✅ FULL UPDATED CODE (Design tightened, blank spaces removed)
// ✅ Data/text unchanged — only layout/design improved
//
// Key changes:
// 1) The right column now includes "Damage Check" under "Tire Pressure" to fill blank space.
// 2) Row uses crossAxisAlignment.stretch so both sides align vertically.
// 3) _SmallMetricCard title uses SAME gradient style as Pressure/Tread.
// 4) Small spacing polish (kept minimal).
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 12 * s), // ✅ slightly tighter

              Expanded(
                child: ListView(
                  padding: EdgeInsets.zero,
                  children: [
                    // ✅ KEY DESIGN FIX: stretch row + fill right column
                    Row(
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              ...
                              // ✅ This fills the blank area on the right
                              Expanded(
