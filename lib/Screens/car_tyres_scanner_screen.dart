...
class _CarTyresScannerScreenState extends State<CarTyresScannerScreen> {
  ...
  Future<void> _stopCameraSafely() async {
    ...
    try {
      // remove preview from tree BEFORE disposing
      if (mounted) {
        setState(() {
          _ready = false;
          _controller = null;
...
class _CarTyresScannerScreenState extends State<CarTyresScannerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ NEW: preview image for selected tyre
...
class _ActiveTyrePreview extends StatelessWidget {
  const _ActiveTyrePreview({
    required this.s,
    required this.label,
    required this.file,
  });
            ...
            child: Container(
              ...
              child: file == null
                  ? Icon(Icons.image_outlined,
                      color: Colors.white.withOpacity(.8), size: 26 * s)
                  : Image.file(
                      File(file!.path),
                      fit: BoxFit.cover,
                    ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6 * s),
                Text(
                  file == null ? "No image selected yet" : "Image ready ✓",
                  style: TextStyle(
                    fontFamily: 'ClashGrotesk',
...
// I/flutter (11557): <= [UPLOAD-4W] 500
// I/flutter (11557): <= Body: <html>
// I/flutter (11557):   <head>
// I/flutter (11557):     <title>Internal Server Error</title>
// I/flutter (11557):   </head>
// I/flutter (11557):   <body>
// I/flutter (11557):     <h1><p>Internal Server Error</p></h1>
// I/flutter (11557):     
// I/flutter (11557):   </body>
// I/flutter (11557): </html>
...
//           if (_ready && _controller != null && !_uploading)
//   Positioned.fill(child: CameraPreview(_controller!))
// else
//   Positioned.fill(child: Container(color: Colors.black)),
