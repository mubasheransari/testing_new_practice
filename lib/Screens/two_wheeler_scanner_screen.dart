...
//   void _retake(TwoTyrePos pos) {
//     setState(() {
//       if (pos == TwoTyrePos.front) _front = null;
//       if (pos == TwoTyrePos.back) _back = null;
//       _active = pos;
//       _error = null;
//     });
//   }
...
//       body: Stack(
//         children: [
//           // ✅ FIX: ALWAYS BOUNDED PREVIEW (NO AspectRatio crash possible)
//           Positioned.fill(
//             child: canPreview
//                 ? _CameraPreviewCover(controller: _controller!)
//                 : const ColoredBox(color: Colors.black),
...
//         fit: BoxFit.cover,
//         child: SizedBox(
//           width: previewSize.height, // NOTE: swapped for correct orientation
//           height: previewSize.width,
//           child: CameraPreview(controller),
//         ),
//       ),
